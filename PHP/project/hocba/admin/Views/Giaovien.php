                ...
                <div class="col-lg-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <a href="http://localhost/PHP/project/hocba/admin/Giaovien/add"class="card-description"> Thêm</a>
                            </p>
                            <table class="table ">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th style="font-weight: bold;"> Lớp chủ nhiệm</th>
                                        <th> </th>
                                    </tr>
                                </thead>
                                <tbody>
                                ...
                                ?>
                                    <tr class="text-center">
                                        <td> <?php echo $row['id_giaovien'] ;?> </td>
                                        ...
                                        <td>  <?php if($row['tenlop']!=null) echo $row['tenlop'];
                                                    else echo "Không chủ nhiệm";
                                               ?> 
                                        </td>
                                        <td>  
                                            <?php 
                                                echo "<button type='button' class='btn btn-primary btn-sm'>
                                                <a class='text-light' href='Giaovien/edit/".$row['id_giaovien']."'> Cập nhật </a> </button>";
                                                echo "<button type='button' class='btn btn-danger btn-sm ml-3'>
                                                <a class='text-light' href='Giaovien/delete/".$row['id_giaovien']."'>Xóa </a> </button>";
                                            ?> 
                                        </td>
                                    </tr>
