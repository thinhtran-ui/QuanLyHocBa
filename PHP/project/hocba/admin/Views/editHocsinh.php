                            ...
                            <main class="my-form">
                                <div class="cotainer">
                                    <div class="row justify-content-center">
                                        <div class="col-md-8">
                                            <div class="card">
                                                <div class="card-header">Cập nhật Học sinh</div>
                                                <div class="card-body">
                                                    <form name="my-form" onsubmit="return validform()" action="" method="Post">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" class="form-control" value="<?php echo $row['mshs']; ?>" name="maso"> <br>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="text" value="<?php echo $row['tenhs'];?>" class="form-control" name="name">
                                                                <br>
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-md-6">
                                                                ...
                                                                ?>
                                                                   <option <?php if($row['id_malop']==$r['id_lop']) echo 'selected'; ?> value="<?php echo $r['id_lop'];?>"> <?php echo $r['tenlop']."(".$r['nam'].")-".$r['tengv']."" ?></option> 
